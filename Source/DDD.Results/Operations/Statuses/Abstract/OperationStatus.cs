...
{
    /// <summary>
    /// The type of the operation status.
    /// </summary>
    public readonly StatusType Type;
    
    /// <summary>
    /// The expected output type of the operation, if applicable.
    /// </summary>
    public readonly Type? OutputType;
    
    /// <summary>
    /// A message providing additional details about the operation status.
    /// </summary>
    ...
    protected OperationStatus(StatusType statusType, Type outputType, string message)
    {
        Type = statusType;
